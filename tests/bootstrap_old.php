...
// Load Brain Monkey API for WordPress function mocking
...
if (file_exists(__DIR__ . '/wordpress/wp-config.php')) {
    ...
    // WordPress functions are mocked by Brain\Monkey in test files
    // Do not define them here to avoid conflicts with Brain\Monkey
